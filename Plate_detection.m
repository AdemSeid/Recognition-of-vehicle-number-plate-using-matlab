...
pause(1); %Delibrately adding 1 second delay

im = imread(fullname); % reading users image
imgray = rgb2gray(im);
...
im = bwareaopen(~im, 100); %remove some object if it width is too long or too small than 500
